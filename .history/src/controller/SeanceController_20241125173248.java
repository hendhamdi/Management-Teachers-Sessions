...
public class SeanceController {
    ...
    public void chercherSeance() {
        String matricule = matriculeSeanceTextField.getText();

        if (matricule == null || matricule.trim().isEmpty()) {
            showError("Veuillez entrer un matricule.");
            return;
        }
        ...
        // Requête SQL pour récupérer les séances par matricule
        String query = "SELECT " +
                "    s.id AS seance_id, " +
                "    s.classe, " +
                "    s.matiere, " +
        ...
        try (Connection connection = DatabaseConnection.getConnection();
            ...
            stmt.setString(1, matricule); // Paramètre pour le matricule de l'enseignant
            try (ResultSet rs = stmt.executeQuery()) {
                ...
                if (found) {
                    ...
                    showError("Aucune séance trouvée pour ce matricule.");
                }
            }
