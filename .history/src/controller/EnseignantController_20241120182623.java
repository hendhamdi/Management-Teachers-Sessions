...
public class EnseignantController {
    ...
    private void enregistrerSeance() {
        ...
        if (classe == null || matiere == null || jour == null || heure == null || matriculeEnseignant.isEmpty()) {
            showAlert(Alert.AlertType.WARNING, "Erreur", "Tous les champs doivent être remplis.");
            return;
        }
        ...
        try (Connection connection = DatabaseConnection.getConnection();
            ...
            statement.setString(5, matriculeEnseignant);
    ...
    private void ouvrirRequetes() {
        try {
            ...
            showAlert(Alert.AlertType.ERROR, "Erreur",
                    "Impossible de charger l'interface des requêtes : " + e.getMessage());
        }
    }
