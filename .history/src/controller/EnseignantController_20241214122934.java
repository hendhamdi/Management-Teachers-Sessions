...
public class EnseignantController {
    ...
    private void enregistrerSeance() {
        ...
        // Vérifier s'il existe déjà une séance au même jour et même heure pour la même
        // classe
        ...
        try (Connection connection = DatabaseConnection.getConnection();
            ...
            if (checkResult.next() && checkResult.getInt(1) > 0) {
                ...
                return; // Ne pas enregistrer la séance si un conflit existe
            }
        } catch (SQLException e) {
        ...
        // Si aucune séance conflictuelle n'existe, enregistrer la séance
