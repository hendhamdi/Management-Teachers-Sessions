...
public class SeanceController {
    ...
    public void initialize() {
        ...
        ObservableList<String> classes = FXCollections.observableArrayList("Classe A", "Classe B", "Classe C");
        classeComboBox.setItems(classes);

        ObservableList<String> matieres = FXCollections.observableArrayList("Math", "Physique", "Chimie");
