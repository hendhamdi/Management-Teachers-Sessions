...
public class EnseignantController {
    ...
    @FXML
    private TextField nomField, matriculeField, contactField, matriculeEnseignantField;
    @FXML
    private ComboBox<String> classeComboBox, matiereComboBox, jourComboBox, heureComboBox;
    @FXML
    private TableView<Enseignant> enseignantsTable;
    @FXML
    private TableColumn<Enseignant, String> matriculeColumn, nomColumn, contactColumn;

    private final ObservableList<String> classes = FXCollections.observableArrayList("Licence", "Master 1", "Master 2");
    private final ObservableList<String> matieres = FXCollections.observableArrayList("Dev.Web", "Dev.Mobile",
            "Anglais", "Réseaux", "SE");
    private final ObservableList<String> jours = FXCollections.observableArrayList("Lundi", "Mardi", "Mercredi",
            "Jeudi", "Vendredi");
    private final ObservableList<String> heures = FXCollections.observableArrayList("08:00", "10:00", "12:00", "14:00",
            "16:00", "18:00");

    @FXML
    public void initialize() {
        // Liaison des ComboBox avec leurs listes
