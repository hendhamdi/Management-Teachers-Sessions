...
public class SeanceController {
    ...
    public void chercherSeance() {
        ...
        try (Connection connection = DatabaseConnection.getConnection();
                PreparedStatement stmt = connection.prepareStatement(
                        "SELECT * FROM seances s JOIN enseignants e ON s.matricule_enseignant = e.id WHERE s.classe = ? AND s.matiere = ?")) {
    ...
    public void chercherEmploiTemps() {
        ...
        try (Connection connection = DatabaseConnection.getConnection();
                PreparedStatement stmt = connection.prepareStatement(
                        "SELECT * FROM seances s JOIN enseignants e ON s.matricule_enseignant = e.id WHERE s.classe = ? ORDER BY s.jour, s.heure")) {
