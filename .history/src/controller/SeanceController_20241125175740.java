...
public class SeanceController {
    ...
    public void chercherSeance() {
        ...
        // Vérifier que l'utilisateur a bien sélectionné une classe et une matière
        ...
        // La requête SQL avec jointure et filtres sur la classe et la matière
        String query = "SELECT " +
                "    s.id AS seance_id, " +
                "    s.classe, " +
                "    s.matiere, " +
                ...
                "WHERE " +
                "    s.classe = ? AND s.matiere = ? " + // Ajouter les filtres sur classe et matière
                "ORDER BY " +
                "    s.jour, s.heure"; // Optionnel, pour trier les séances par jour et heure

        try (Connection connection = DatabaseConnection.getConnection();
                PreparedStatement stmt = connection.prepareStatement(query)) {

            // Lier les paramètres à la requête (classe et matière)
