...
public class SeanceController {
    ...
    public void chercherEmploiTemps() {
        ...
        String query = "SELECT s.id, s.classe, s.matiere, s.jour, s.heure, e.nom, e.contact " +
                "FROM seances s " +
                "INNER JOIN enseignants e ON s.matricule_enseignant = e.matricule " + // Jointure interne
                "WHERE s.classe = ? " + // Filtrer par classe
                "ORDER BY s.jour, s.heure"; // Trier par jour et heure
