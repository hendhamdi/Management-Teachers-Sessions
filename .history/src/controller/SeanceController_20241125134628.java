...
public class SeanceController {
    ...
    public void chercherSeance() {
        ...
        // Vérifier si la classe et la matière sont sélectionnées
        if (classe == null || matiere == null) {
            showError("Veuillez sélectionner une classe et une matière.");
            return;
        }

        seancesList.clear(); // Effacer les résultats précédents

        // Requête SQL pour récupérer les séances filtrées par classe et matière
        ...
        try (Connection connection = DatabaseConnection.getConnection();
            ...
            try (ResultSet rs = stmt.executeQuery()) {
                ...
                Platform.runLater(() -> resultList.setItems(seancesList));
            }
    ...
    public void chercherEmploiTemps() {
        ...
        // Requête SQL pour récupérer les séances filtrées par classe (emploi du temps)
