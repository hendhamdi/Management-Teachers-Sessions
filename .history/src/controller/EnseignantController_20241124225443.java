    ...
    private void afficherSeances() {
        ...
        try (Connection connection = DatabaseConnection.getConnection();
            ...
            while (resultSet.next()) {
                ...
                seancesTable.setItems(seance);
            }

            // Lier les colonnes aux propriétés de Seance
            ...
            matriculeColumn.setCellValueFactory(new PropertyValueFactory<>("matriculeEnseignant"));
