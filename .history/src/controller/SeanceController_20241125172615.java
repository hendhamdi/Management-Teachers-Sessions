...
public class SeanceController {
    ...
    public void chercherEmploiTemps() {
        ...
        String query = "SELECT " +
                ...
                "    seances s " +
                "INNER JOIN " +
                "    enseignants e " + // Jointure interne
                "ON " +
                "    s.matricule_enseignant = e.matricule " + // Condition de jointure
                "WHERE " +
                "    s.classe = ? " + // Filtrage par classe
                "ORDER BY " +
                "    s.jour, s.heure"; // Tri des résultats par jour et heure
